...
```mermaid
flowchart LR
    A["Messy manual work"] --> B["Workflow map"]
    B --> C["Rules, tools, and data"]
    C --> D["AI where context matters"]
    D --> E["Human review points"]
    E --> F["Dashboard + business outcome"]

    style A fill:#F7F4EE,stroke:#1C1917,color:#1C1917
    style B fill:#E6E6E6,stroke:#C8814A,color:#1C1917
    style C fill:#F7F4EE,stroke:#1C1917,color:#1C1917
    style D fill:#1C1917,stroke:#C8814A,color:#F7F4EE
    style E fill:#F7F4EE,stroke:#C8814A,color:#1C1917
    style F fill:#C8814A,stroke:#1C1917,color:#1C1917
```
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=rect&height=54&color=C8814A&text=MAKE%20THE%20WORKFLOW%20VISIBLE.%20MAKE%20THE%20PRODUCT%20USEFUL.&fontColor=1C1917&fontSize=18&fontAlignY=55&animation=fadeIn" alt="Make the workflow visible. Make the product useful." />
